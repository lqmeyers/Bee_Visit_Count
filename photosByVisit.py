...
def main(trackFile,vidFile,jsonFile,outputPath,writelog=False):
  ...
  visitFile = open(jsonFile)
  visits = json.load(visitFile)
...
visitJson = '/mnt/c/Users/lqmey/OneDrive/Desktop/Bee_Visit_Count/visits.json' #visits json created by running event detect 

main(filename,vidFile,visitJson,'/home/lqmeyers/SLEAP_files/Bee_imgs/test/')